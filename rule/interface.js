...
export default {
  ...
  branch: (/** @type {any} */ $) =>
    seq(
      choice(
        ...
        seq(kw("ON ACTION"), field("action", choice($.identifier, $.string))),
  ...
  clear: (/** @type {any} */ $) => seq(kw("CLEAR"), $._params),
  message: (/** @type {any} */ $) =>
  ...
  menu: (/** @type {any} */ $) =>
    seq($._menu_head, optional(repeat($.branch)), kw("END MENU")),
