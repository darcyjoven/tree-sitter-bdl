...
export default {
  ...
  _display_attribute: ($) =>
    choice(
      ...
      seq(kw("COMMENT"), "=", $._expression),
      seq(kw("IMAGE"), "=", $._expression),
      // COLOR
      kw("BLACK"),
      kw("BLUE"),
      kw("CYAN"),
      ...
      kw("BLINK"),
      kw("UNDERLINE"),
      seq(kw("PROMPT"), kw("LINE"), $._expression),
      seq(kw("FORM"), kw("LINE"), $._expression),
      seq(kw("MENU"), kw("LINE"), $._expression),
      seq(kw("MESSAGE"), kw("LINE"), $._expression),
      seq(kw("ERROR"), kw("LINE"), $._expression),
